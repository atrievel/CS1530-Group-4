...
WebUI.setText(findTestObject('Thread Testing/input_txtTitle'), 'test ty')
...
WebUI.click(findTestObject('Thread Testing/div_Your new thread was create'))

WebUI.verifyElementVisible(findTestObject('Thread Testing/button_OK'))
