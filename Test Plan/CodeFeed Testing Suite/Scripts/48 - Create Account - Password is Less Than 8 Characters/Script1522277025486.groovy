...
WebUI.setText(findTestObject('Page_Register  CodeFeed/input_username'), 'test48')

WebUI.setText(findTestObject('Page_Register  CodeFeed/input_password'), '1234567')

WebUI.setText(findTestObject('Page_Register  CodeFeed/input_verify_password'), '1234567')
