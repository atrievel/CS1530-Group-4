...
WebUI.setText(findTestObject('Page_Register  CodeFeed/input_username'), 'test51')

WebUI.setText(findTestObject('Page_Register  CodeFeed/input_password'), '123456789')

WebUI.setText(findTestObject('Page_Register  CodeFeed/input_verify_password'), 'abcdefghi')
