...
WebUI.setText(findTestObject('Page_Register  CodeFeed/input_name'), 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')

WebUI.setText(findTestObject('Page_Register  CodeFeed/input_email'), 'test@example.com')

WebUI.setText(findTestObject('Page_Register  CodeFeed/input_username'), 'test38')
